...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'my_first_nodejs';
    ...
    'jhipster.mail.from' = 'my_first_nodejs@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'my_first_nodejs API';
    'jhipster.swagger.description' = 'my_first_nodejs API documentation';
    ...
    'eureka.instance.appname' = 'my_first_nodejs';
    'eureka.instance.instanceId' = 'my_first_nodejs:${random.value}';
    ...
    'cloud.config.name' = 'my_first_nodejs';
